...
$eventC=new eventC();
$listerec=$eventC->recherche($_POST['rech']);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <form class="search-form" action="rech.php" method="post">
              <i class="icon-search"></i>
              <input type="search" class="form-control" placeholder="Search Here" title="Search here" name="rech">
            </form>
          </li>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                   <a  class="btn btn-primary" href="tri.php">Tri par date</a>
                  </p>
            ...
            ?>
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $rec['typeE']; ?></td>
                          <td><?php echo $rec['dateE']; ?></td>
                          <td><?php echo"<img src='./uploads/".$rec['image']."'>" ?>
      <style>
            img{
            width: 90px;
                        height: 90px;         
                          ...
                          <td> 
<form method="post" action="supprumerev.php">
<input  class="btn btn-primary" type="submit" value="Supprimer">
<input type="hidden" value="<?php echo$rec['id']; ?>" name="rec">
</form></td>
        <td> 
...
?>
      ...
      <form action="ajouterevnt.php">      
       <button type="submit" class="btn btn-primary me-2">Ajouter event</button>
        </form>
