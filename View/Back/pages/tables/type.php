        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            ?>
                      <tbody>
                        <tr>
                          <td><?php echo $rec['nom_type']; ?></td>
                          <td><?php echo $rec['discount']; ?></td>
                       
                          <td> 
<form method="post" action="supprumetype.php">
...
?>
      ...
      <form action="ajoutertype.php">      
       <button type="submit" class="btn btn-primary me-2">Ajouter Type</button>
        </form>
