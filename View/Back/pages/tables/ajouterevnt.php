          ...
          function check(){
             var nomR=document.frm.nom.value;
              ...
              if (!(nomR.match(letters) && nomR.charAt(0).match(/^[A-Z]+$/))){
                  ...
                  <form name="frm" class="forms-sample" action="fctajou.php" method="post" enctype="multipart/form-data" onsubmit="return check()">
                    ...
                    <div class="form-group">
                         <label for="exampleInputUsername1">Type</label><br>
                         <select name="id_type" >
  
                    <?php
foreach($listerec as $caa){
?>
       <option value="<?php echo $caa['id'] ?>"><?php echo $caa['nom_type'] ?></option>
         <?php } ?>
         </select>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Date</label>
                      <input type="date" class="form-control" name="dat" value="" >
