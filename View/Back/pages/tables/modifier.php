...
$eventC=new eventC();
$listerec=$eventC->afficherreeventseule($_POST['rec']);
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          ...
          function check(){
            ...
            ?>
                  <form name="frm" class="forms-sample" action="fctmod.php" method="post" onsubmit="return check()">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Nom</label>
                      <input type="text" class="form-control" name="nom" value="<?php echo $rec['nomE']; ?>" >
                                   <span id="msg" style="color:red"></span></th>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Date</label>
                      <input type="date" class="form-control" name="dat" value="<?php echo $rec['dateE']; ?>" >
