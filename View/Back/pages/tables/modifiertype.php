...
$typeC=new typeC();
$listerec=$typeC->afficherretypeseule($_POST['rec']);
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          <div class="row">
            ...
            ?>
                  <form class="forms-sample" action="fctmodtype.php" method="post">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Type</label>
                      <input type="text" class="form-control" name="type" value="<?php echo $rec['nom_type']; ?>" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Discount</label>
                      <input type="number" class="form-control" name="dis" value="<?php echo $rec['discount']; ?>" >
