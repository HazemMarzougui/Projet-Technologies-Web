...
<?php
  ...
  include_once '../../../../Model/Produits.php';
	...
	{
		$listeProduit=$produitC->Recherche($_GET['search']);
	}
	else{
  ...
  if(isset($_GET['tr'])){
    $listeProduit=$produitC->TriNom();
  }
  elseif(isset($_GET['aa'])){
    $listeProduit=$produitC->TriPrixAs();
  }
  elseif(isset($_GET['dd'])){
    $listeProduit=$produitC->TriPrixDec();
  }
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            ...
            <h3 class="welcome-sub-text">Votre Plateforme de Ménagement </h3>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto">
          ...
          <li>
            <div style="margin-left: 13px;">
              <a type="submit" class="btn btn-danger btn-sm" href="../../logout.php" >Log Out</a>
            </div>
          </li>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          ?>
                ...
                <br>
                  ...
                  <div>
                  <a class="btn btn-primary" href="AjouterProduit.php" role="button">Nouveau Produit</a>
                  <a class="btn btn-primary" href="AfficherC.php" role="button">Liste des Categories</a>
                  <div class="btn-group">
  					<button style = "position:relative; left:-230px; top:-65px"; type="button"  class="btn btn-danger dropdown-toggle"  name="fltr" id="fltr"  data-bs-toggle="dropdown" aria-expanded="false">
    				Filtrer par
  					</button>
  				<ul class="dropdown-menu">
    		<li><a class="dropdown-item" href="AfficherProduit.php?tr=y">Nom A->Z </a></li>
    		<li><a class="dropdown-item" href="AfficherProduit.php?aa=y">Prix Croissant </a></li>
    		<li><a class="dropdown-item" href="AfficherProduit.php?dd=y">Prix Décroissant</a></li>
  				</ul>
					</div>
                </div>
                <td></td>
		   ...
		   <thead>
			...
			<tr>
				...
				<td><img style="max-width: 150%;max-height=150%" src="./image/<?php echo $produits['img']; ?>"></td>
				<td><?php echo $produits['descriptionn']; ?></td>
				<td><?php 	
				$category = $produitC->RecupererCategorie($produits['idC']);
				$nomC=$category['NomC'];
				echo $nomC;						?></td>
				<td><?php echo $produits['dateCreation']; ?></td>
				<td>
				...
				<td>
					<a  class="btn btn-danger btn-sm"   href="SupprimerProduit.php?idProduit=<?php echo $produits['idProduit']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Copyright © 2021. Switchini  All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
