...
if (		
    ...
    if ( !empty($_POST["NomC"])) {
        ...
        header("Location:AfficherC.php?successMessage=Categorie ajouté avec succés");
...
<body>
  <div class="container-scroller">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control"  name="NomC" id="NomC"  placeholder= "Nom Categorie" onkeyup="nameValidationC()" required >
        <div>
        <p style="color :red" id="categorie"></p>                 
       </div>
    </div>
</div>
