    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#logout" aria-expanded="false" aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-card-text-outline"></i>
...
<table>
			<thead>
				<td><a class="btn btn-primary" href="AjouterRole.php" role="button">Nouveau Role</a></td>
				<td></td>
				<td></td>
				<td></td>
				
				<td><a class="btn btn-primary" href="AfficherUser.php" role="button">Liste des Utilisateurs</a></td>
			</thead>
		</table>
      ...
      <table class="table">
		   <thead>
			...
			?>
			<tr>
				<td><?php echo $role['idR']; ?></td>
				<td><?php echo $role['NomR']; ?></td>
				<td>
					<form method="GET" action="ModifierRole.php">
						<input type="submit"  class="btn btn-primary btn-sm" name="Modifier" value="Modifier">
						<input type="hidden"  value=<?php echo $role['idR']; ?>  name="idR">  
					</form>
				</td>
				<td>
					<a  class="btn btn-danger btn-sm"   href="SupprimerR.php?idR=<?php echo $role['idR']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
