    ...
    if (		
        ...
        if (			
          ...
          $password= password_hash($_POST['passworduser'], PASSWORD_DEFAULT);
           ...
           header('Location:AfficherUser.php?mess=User Modifé avec succés');
        }
        else{
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">        
		...
		<?php
			if (isset($_GET['idU'])){
				$user = $userC->RecupererUser($_GET['idU']);
				
		?>
    
        <form method="POST" action="ModifierUser.php?Modifier=Modifier">
            <!--------------------------------------------Nom Produit------------------------------------------------->
            <div class="row mb-3">
            ...
            <div class="row mb-3">
             ...
             <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="password" class="form-control" name="passworduser" id="passworduser" value="<?php echo $user['passworduser']; ?>">
                </div>
             </div>
            ...
            <div class="input-group mb-3">
                    <label class="col-sm-3 col-form-label ">Role</label>
                      <div class="col-sm-6">
	                    ...
	                    $listeRole=$userC->AfficherRole();
                        foreach($listeRole as $role){ ;
                        ?>
                        <option id="<?php echo $role['idR']; ?>" class="form-control" value="<?php echo $role['idR']; ?>" ><?php echo $role['NomR']; ?></option>    
                        <?php
                        //fin foreach 
                        }
                        ?>
