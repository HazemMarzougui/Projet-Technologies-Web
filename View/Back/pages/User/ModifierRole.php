<?php
    ...
    if (		
        ...
        if (			
            ...
            $roleC->ModifierRole($role, $_GET["idR"]);
            header('Location:AfficherRole.php?mess=Role Modifé avec succés');
        }
        else
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">        
		...
		<?php
			if (isset($_GET['idR'])){
				$role = $roleC->RecupererRole($_GET['idR']);
        ...
        <form method="post" onchange ="Verif();" >
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="NomR" id="NomR" value="<?php echo $role['NomR'];?>">
                    <a id="test1"></a>
                </div>
            </div>
...
<!---------------------------------------------Buttons---------------------------------------------->
             ...
             <div class="col-sm-3 d-grid">
                 <a class="btn btn-primary" href="AfficherR.php" role="button">Retour</a>
             </div>
          </div>
            </table>
        </form>
