...
if (		
    ...
    !empty($_POST["NomR"]) ){
        ...
        */
        ...
        header("Location:AfficherUser.php?successMessage=User ajouté avec succés");
    }
    else
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown d-none d-lg-block">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content flex-grow py-2">
                  <p class="preview-subject ellipsis font-weight-medium text-dark">Gestion Reclamations</p>
                </div>
              </a>
              <a class="dropdown-item preview-item">
                <div class="preview-item-content flex-grow py-2">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class=" input-group mb-3 ">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control"  name="nom" id="nom"  placeholder= "Nom Utlisateur" onkeyup="nameValidation()" required >
            ...
            <div class=" input-group mb-3 ">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control"  name="prenom" id="prenom"  placeholder= "Prenom Utlisateur" onkeyup="prenomValidation()" required >
            ...
            <label class="col-sm-3 col-form-label ">Adresse</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="adresse" id="adresse"  aria-label = "adresse" placeholder ="Adresse"  onkeyup="adresseValidation()" required >
                    <div>
            ...
            <!---------------------------------------------Email---------------------------------------------->
                <div class="input-group mb-3">
                    <label class="col-sm-3 col-form-label ">Email</label>
                      <div class="col-sm-6">
                    <input type="text" class="form-control" name="email" id="email"  placeholder ="Email"  onkeyup="emailValidation()" requireds >
                    <div>
            ...
            <div class="input-group mb-3">
                    <label class="col-sm-3 col-form-label ">Password</label>
                      <div class="col-sm-6">
                    <input type="password" class="form-control" name="passworduser" id="passworduser"  onkeyup="passValidation()" required >
             <div>
            <p style="color :red" id="passr"></p>
            </div>
                </div>
            </div>
            ...
            <div class="input-group mb-3">
                    <label class="col-sm-3 col-form-label ">Role</label>
                      <div class="col-sm-6">
                        <select id="CatId" name="NomR"  class="form-control"  >
                        <?php 
	                    ...
	                    $listeRole=AfficherRole();
                        foreach($listeRole as $role){ 
                        ?>
                        <option value="<?php echo $role['idR']; ?>" class="form-control" ><?php echo $role['NomR']; ?></option>    
                        <?php
                        //fin foreach 
                        }
                        ?>
...
<!---------------------------------------------Buttons---------------------------------------------->
             ...
             <div class="col-sm-3 d-grid">
                 <a class="btn btn-primary" href="AfficherUser.php" role="button">Retour</a>
             </div>
          </div>
            </table>
        </form>
