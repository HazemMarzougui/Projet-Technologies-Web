<?php
	...
	{
		$listeUser=$userC->Recherche($_GET['search']);
	}
	elseif(isset($_GET['tr']))
	{
		$listeUser=$userC->triUser();
	}
	else{
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <a class="btn btn-primary"  href="javascript:window.print()">Imprimer </a>
             ...
             <div>
          <a class="btn btn-primary" href="AjouterUser.php" role="button">Nouveau Utilisateur</a>
          <a class="btn btn-primary" href="AfficherRole.php" role="button">Liste des Roles</a>
          <a class="btn btn-primary" href="AfficherUser.php?tr=y" role="button">Trier la liste</a> 
        </div>
		   ...
		   <thead>
			...
			<tr>
				...
				<td><?php 	
				$roleA = $userC->RecupererRole($user['idR']);
				$nomR=$roleA['NomR'];
				echo $nomR;	?></td>
				...
				<td>
					<a  class="btn btn-danger btn-sm"   href="SupprimerUser.php?idU=<?php echo $user['idU']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
