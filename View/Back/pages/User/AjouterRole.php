...
if (		
    ...
    if ( !empty($_POST["NomR"])) {
        ...
        $roleeC->AjouterRole($role);
        header("Location:AfficherRole.php?successMessage=Role ajouté avec succés");

        
        
    }
    else
        $errorMessage = "<label id='NomR'  style = 'color: red; font-weight: bold;'>&emsp;Remplir Tous les Champs</label>";       
}   
?>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Nouveau Role</h4>
...
<div class=" input-group mb-3 ">
    <label class="col-sm-3 col-form-label ">Nom Role</label>
    <div class="col-sm-6">
        <input type="text" class="form-control"  name="NomR" id="NomR" value="<?php echo $NomR; ?>" placeholder= "Nom Role" onkeyup="roleValidation()" required>
        <a id="testt"></a>
        <div>
            <p style="color :red" id="roler"></p>
            </div>
...
<!---------------------------------------------Buttons---------------------------------------------->
 ...
 <div class="col-sm-3 d-grid">
     <a class="btn btn-primary" href="AfficherRole.php" role="button">Retour</a>
 </div>
</div>
</form>
                </div>
